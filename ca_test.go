...
func bogusCurrentAuthority_codecov() error {
	var nilReg *CurrentAuthority = new(CurrentAuthority)

	if err := testBogusCurrentAuthoritySetters(nilReg); err != nil {
		return err
	}
	if err := testBogusCurrentAuthorityGetters(nilReg); err != nil {
		return err
	}
...
func testBogusCurrentAuthorityGetters(nilReg *CurrentAuthority) error {
...
func testBogusCurrentAuthoritySetters(nilReg *CurrentAuthority) error {
