...
func bogusFirstAuthority_codecov() error {
	var nilReg *FirstAuthority = new(FirstAuthority)

	if err := testBogusFirstAuthoritySetters(nilReg); err != nil {
		return err
	}
	if err := testBogusFirstAuthorityGetters(nilReg); err != nil {
		return err
	}
...
func testBogusFirstAuthorityGetters(nilReg *FirstAuthority) error {
...
func testBogusFirstAuthoritySetters(nilReg *FirstAuthority) error {
